    ...
    <div className='question-details-page'>
        {
            ...
            <>
                {
                    questionsList.data.filter(question => question._id === id).map(question => (   /*single element lidho che question karine and enu id e url na id sathe match karayu che map ni help thi ques throw pass thase*/
